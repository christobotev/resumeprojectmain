 ...
 */
class Version20160425111219 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->connection->insert('Resources', array('resourceID' => NULL,'name' =>'Docs_MainBundle_Controller_UsersController_listAllAction'));
        ...
        $resource = $this->connection->executeQuery("
                ...
                FROM
                    Resources
                WHERE
                    name = 'Docs_MainBundle_Controller_UsersController_listAllAction'
                ");
