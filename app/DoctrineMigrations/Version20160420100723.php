 ...
 */
class Version20160420100723 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->connection->insert('Resources', array('resourceID' => NULL,'name' =>'Docs_MainBundle_Controller_DefaultController_indexAction'));
        ...
        $resource = $this->connection->executeQuery("
                ...
                FROM
                    Resources
                WHERE
                    name = 'Docs_MainBundle_Controller_DefaultController_indexAction'
                ");
