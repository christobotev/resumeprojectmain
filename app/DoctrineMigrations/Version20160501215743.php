 ...
 */
class Version20160501215743 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->connection->insert('Resources', array('resourceID' => NULL,'name' =>'Docs_MainBundle_Controller_AppointmentsController_addAppointmentModalAction'));
        ...
        $resource = $this->connection->executeQuery("
                ...
                FROM
                    Resources
                WHERE
                    name = 'Docs_MainBundle_Controller_AppointmentsController_addAppointmentModalAction'
                ");
